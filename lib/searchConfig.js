...
export const PRIORITY_SITES = [
    ...
    { domain: "google.com", weight: 100, label: "Google" },
    { domain: "main.sci.gov.in", weight: 91, label: "Supreme Court of India" },
    { domain: "delhihighcourt.nic.in", weght: 95, label: "Delhi High Court" },
...
export const BING_HTML_TEXT_CONFIG = {
    baseUrl: "https://www.bing.com/search",
    userAgent: "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36",
};

export const BING_HTML_IMAGE_CONFIG = {
    baseUrl: "https://www.bing.com/images/search",
    userAgent: "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36",
};

export const BING_HTML_VIDEO_CONFIG = {
...
export function resolveSearchProvider(priority = CUSTOM_SEARCH_PRIORITY) {
    ...
    const hasBrave = Boolean(BRAVE_SEARCH_CONFIG.apiKey);
...
export function getSearchProviderOrder(priority = CUSTOM_SEARCH_PRIORITY) {
    ...
    // User explicitly requested Google Search as 1st priority always
    if (hasGoogleKey) {
        add("google", true);
    } else {
    ...
    // Then fallback to headless Bing Text Scraper (most stable bypass)
    add("bing_html", true);
...
export const CUSTOM_LLM_CONFIG = {
    provider: process.env.CUSTOM_LLM_PROVIDER || "openai",
    url: process.env.CUSTOM_LLM_URL || process.env.CUSTOM_LLM_BASE_URL || "http://127.0.0.1:1234/v1",
    apiKey: process.env.CUSTOM_LLM_API_KEY || "",
    model: process.env.CUSTOM_LLM_MODEL || "lmstudio-model",
